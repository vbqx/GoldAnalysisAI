# TradingAgentCN — XAUUSD PA+ICT 分析报告 MVP

基于 Price Action + ICT 方法论，自动生成类似群友分享的黄金（XAUUSD）机构级分析仪表盘。

## 快速开始

```bash
cd d:\Project\TradingAgentCN
python -m venv .venv
...
| 模块 | 状态 |
|------|------|
| 实时价格 / 日涨跌 | ✅ Yahoo Finance |
| 多周期结构 (15m/1h/4h) | ✅ 简化 swing 算法 |
| BOS / CHoCH | ✅ 突破前高/前低 |
...
**回退链：** TradingView → Yahoo Finance → 演示数据
