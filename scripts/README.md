...
| 脚本 | 说明 |
|------|------|
| `export_sample_report.py` | 生成 `docs/aspice/SWE.3-detailed-design/reference/examples/sample-report.json`（无网络） |
...
Get-Content -Encoding UTF8 docs/aspice/SWE.3-detailed-design/reference/pipeline-steps.yaml
```
