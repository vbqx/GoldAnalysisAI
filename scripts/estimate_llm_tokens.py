...
def main() -> int:
    ...
    stages = [
        ...
        ("bullish", "FAST", _sys("src.agents.llm.stages.bullish"), research_payload(ctx, team, "bullish")),
        ("bearish", "FAST", _sys("src.agents.llm.stages.bearish"), research_payload(ctx, team, "bearish")),
        ("debate", "STRONG", _sys("src.agents.llm.stages.debate"), debate_payload(bull, bear, ctx.analyses, ctx=ctx, team=team)),
        ("trader", "STRONG", _sys("src.agents.llm.stages.trader"), trader_payload(ctx, debate, signals, team=team)),
