...
> 来源：[docs/aspice/records/reviews/financial/static-code-review.md](../../docs/aspice/records/reviews/financial/static-code-review.md) §6
...
| 看多主导时 `must_do` 含做多主策略，`action` 不套用看空模板 |
| 震荡主导时文案为区间等待，非单边追空/追多 |
