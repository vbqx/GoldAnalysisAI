...
本文只维护“计划、优先级、验收标准”。稳定架构事实放在 [architecture.md](../aspice/SWE.2-architecture/system-overview.md)，LLM 阶段细节放在 [llm-agents.md](../aspice/SWE.2-architecture/llm-agents.md)，金融风险发现与验收记录放在 [reviews/findings-status.md](../aspice/records/reviews/findings-status.md) 与 [reviews/financial/static-code-review.md](../aspice/records/reviews/financial/static-code-review.md)。
...
| P0 | LLM 研究 + 辩论 + 流式 I/O | 已完成 | [llm-agents.md](../aspice/SWE.2-architecture/llm-agents.md) |
...
| P1 | LLM 点位提议 + 规则 validator | 已完成 | [architecture.md §8.1](../aspice/SWE.2-architecture/system-overview.md#81-llm-点位层) |
| P2 | LLM 交易员 / 风控 / 经理 | 已完成基础接入 | `src/agents/llm/stages/` |
| P2 | 单次 decision synthesis 兼容路径与 staged A/B 回放 | 计划中 | [llm-agents.md §3.9](../aspice/SWE.2-architecture/llm-agents.md#39-单次综合推理迁移方案计划中) |
...
目标：继续把界面维持在“先给交易判断，再给证据链审计”的结构。GUI-1 至 GUI-5 已完成首轮落地；历史验收快照已归档到 [reviews/gui/streamlit-acceptance-2026-07-08.md](../aspice/records/reviews/gui/streamlit-acceptance-2026-07-08.md)。
