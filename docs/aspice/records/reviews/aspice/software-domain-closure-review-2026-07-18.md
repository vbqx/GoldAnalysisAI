...
| SWE.2 | PASS | 11 个组件、4 个受控架构接口、6 个集成步骤；双向链接无悬挂 | [软件架构](../../../SWE.2-architecture/README.md)、[IT](../../../SWE.5-integration-testing.md) |
| SWE.3 | PASS | 182/182 unit 和 1068/1068 function 有稳定 ID；逐函数设计字段 100% | [软件详细设计](../../../SWE.3-detailed-design/README.md) |
