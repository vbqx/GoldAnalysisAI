...
| SWE.2 软件架构设计 | P 部分满足 | `docs/aspice/SWE.2-architecture/` 有静态分层、数据流、模式和接口说明 | 无架构元素 ID、接口全集、架构分析准则/结果、需求↔架构双向追溯 |
...
- 当前文档：`README.md`、`docs/management/`、`docs/aspice/SWE.2-architecture/`、`docs/aspice/SWE.3-detailed-design/reference/`、`docs/aspice/governance/verification-strategy.md`、`docs/aspice/records/reviews/`
...
- `docs/management/project.md` 说明产品定位和能力边界。
- `docs/management/roadmap.md` 包含目标、阶段任务和部分验收条件。
- `tests/cases/catalog.yaml` 有 116 条目录项，其中 42 条 unit、12 条 integration、8 条 regression、49 条 manual；58 条标为自动、53 条标为手工，5 条未填写。
- `docs/management/audit-plan.md` 对报告可信度和运行审核给出较强的不变量要求。
...
- `docs/aspice/SWE.2-architecture/system-overview.md` 给出数据流、分层、主组件和关键对外接口。
- `llm-agents.md`、`report-trust.md`、`backtesting.md`、`technical-analysis.md` 等文档补充分支模式和领域架构。
- `docs/aspice/SWE.3-detailed-design/reference/handbook.md` 提供模块职责、调用入口和最小测试建议。
...
- 发现实际文档漂移：`docs/aspice/SWE.3-detailed-design/reference/handbook.md` 仍称 `src/backtest/` 包含 `replay.py`，当前实现不存在该文件。
...
- `docs/aspice/governance/verification-strategy.md` 区分 fast/full/release 层级。
...
- 本报告：`docs/aspice/records/reviews/aspice/software-domain-document-audit-2026-07-17.md`
- 逐函数附录：`docs/aspice/records/reviews/aspice/software-function-audit-2026-07-17.csv`
- 机器摘要：`docs/aspice/records/reviews/aspice/software-function-audit-summary-2026-07-17.json`
