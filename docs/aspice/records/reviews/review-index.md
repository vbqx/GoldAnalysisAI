...
| 类型 | 权威位置 |
|------|----------|
| 架构边界（持续维护） | [architecture/review.md](../../SWE.2-architecture/health-review.md) |
| 当前实现与字段 | [architecture/](../../SWE.2-architecture/) · [reference/](../../SWE.3-detailed-design/reference/) |
| 后续计划 | [planning/roadmap.md](../../../management/roadmap.md) |
...
| 🔄 持续维护 | 架构 · 健康检查 | [architecture/review.md](../../SWE.2-architecture/health-review.md) | — | 全栈边界 | 非历史流水账；评估模块是否臃肿、边界是否清晰 |
