...
| [configuration management](../aspice/configuration-management.yaml) | Configuration Item/Baseline | agreed | normative |
| [dependency lock](../aspice/dependency-lock.txt) | Configuration Item/Baseline | agreed | normative |
| [ASPICE 文档控制与归类规则](../aspice/document-control.md) | Document Control | agreed | normative |
| [document register](../aspice/document-register.csv) | Configuration Status Record | generated | generated |
| [pip resolution](../aspice/pip-resolution.json) | Configuration Item/Baseline | agreed | normative |
| [ASPICE 过程文档索引](../aspice/process-document-index.md) | Configuration Status Record | generated | generated |
| [Automotive SPICE 软件工程工作产品](../aspice/README.md) | Document Control | agreed | normative |
| [sbom](../aspice/sbom.json) | Configuration Item/Baseline | agreed | normative |
...
| 文档 | 信息项 | 状态 | 权威性 |
|---|---|---|---|
| [software requirements](../aspice/software-requirements.yaml) | 17-00 Requirement | agreed | normative |
...
| [software architecture](../aspice/software-architecture.yaml) | 04-04 Software Architecture | agreed | normative |
