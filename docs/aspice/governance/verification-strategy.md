...
- 改流水线阶段必须同步 `docs/aspice/SWE.3-detailed-design/reference/pipeline-steps.yaml`。
- 改报告字段必须同步 `docs/aspice/SWE.3-detailed-design/reference/examples/report-schema.md`。
- 改事实注册/不变量/证据溯源必须同步 [report-trust.md](../SWE.2-architecture/report-trust.md)。
