...
本文件保存 2026-07-08 的 Streamlit GUI 验收记录。当前 UI 事实以 `src/viz/`、[docs/operations/walkthrough.md](../operations/walkthrough.md) 和 [docs/testing/strategy.md](../testing/strategy.md) 为准。
